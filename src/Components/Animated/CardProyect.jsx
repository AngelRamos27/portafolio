...
const CardProyect = ({ proyect }) => {
    ...
    return (
        <>
            <div className="w-80 sm:w-[30rem] lg:w-[45rem] lg:h-[40rem] flex flex-col bg-negroPurpura rounded-lg shadow-lg shadow-pink-500 hover:shadow-purple-600 duration-300 ">
