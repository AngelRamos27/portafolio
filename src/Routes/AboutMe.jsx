...
const AboutMe = () => {
  return (
    <div data-aos="fade-up" className='w-full h-screen text-amarilloMZ  flex flex-col justify-center pb-16  lg:pt-0'>
      <div className='w-full flex lg:flex-row flex-col lg:gap-0 gap-12 items-center justify-between'>
        ...
        <div className='z-40 lg:pt-3 lg:text-2xl text-md lg:text-left text-center p-5 lg:p-0 pt-12 w-full '>
          <p className=''><span className='lg:text-7xl text-2xl'>¡Hola!</span>, me presento, mi nombre es<br /> Luis Angel Ramos Flores, tengo 21 años y desarrollo software,<br /> ¡un gusto!.</p>
