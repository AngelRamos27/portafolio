        ...
        <div className='w-full flex flex-col justify-center items-center h-screen'>
          <div className='flex lg:flex-row flex-col items-center justify-center w-full gap-12 h-screen'>
            <FloatingDiv delay={0.8} width={'relative group lg:w-[35rem]'}>
              <img src={TecAzul} className='rounded-full sm:w-[27rem] sm:h-80 w-52 h-52  shadow-lg shadow-pink-500 group-hover:shadow-purple-600 duration-300'></img>
              <div className="lg:translate-x-[1.8rem] xl:translate-x-[4rem] rounded-full sm:w-[27rem] sm:h-80 w-52 h-52 absolute inset-0 flex items-center justify-center bg-negroPurpura bg-opacity-80 opacity-0 group-hover:opacity-100 transition-opacity">
            ...
            <FloatingDiv delay={0.7} width={'relative group lg:w-[35rem]'}>
              <img src={TecGuinda} className='rounded-full sm:w-[27rem] sm:h-80 w-52 h-52 shadow-lg shadow-pink-500 group-hover:shadow-purple-600 duration-300'></img>
              <div className="lg:translate-x-[1.8rem] xl:translate-x-[4rem] rounded-full sm:w-[27rem] sm:h-80 w-52 h-52 absolute inset-0 flex items-center justify-center bg-negroPurpura bg-opacity-80 opacity-0 group-hover:opacity-100 transition-opacity">
                <p className="text-white   text-center max-w-full p-5">
            ...
            <FloatingDiv delay={0.6} width={'relative group lg:w-[35rem] lg:hidden block'}>
              <img src={Innova} className='rounded-full sm:w-[30rem] sm:h-80 w-52 h-52 shadow-lg shadow-pink-500 group-hover:shadow-purple-600 duration-300'></img>
              <div className="lg:translate-x-[1.8rem] xl:translate-x-[2.5rem] rounded-full sm:w-[30rem] sm:h-80 w-52 h-52 absolute inset-0 flex items-center justify-center bg-negroPurpura bg-opacity-80 opacity-0 group-hover:opacity-100 transition-opacity">
                <p className="text-white text-center max-w-full p-5">
          ...
          <div className='lg:block hidden'>
            <FloatingDiv delay={0.6} width={'relative group lg:w-[35rem]'}>
              <img src={Innova} className='rounded-full sm:w-[30rem] sm:h-80 w-52 h-52 shadow-lg shadow-pink-500 group-hover:shadow-purple-600 duration-300'></img>
              <div className="lg:translate-x-[1rem] xl:translate-x-[2.5rem] rounded-full sm:w-[30rem] sm:h-80 w-52 h-52 absolute inset-0 flex items-center justify-center bg-negroPurpura bg-opacity-80 opacity-0 group-hover:opacity-100 transition-opacity">
